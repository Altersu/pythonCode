...
#                 print(f'删除学生信息成功, 删除的姓名为: {del_name}')
#                 break
#         else:
#                 print(f'没有找到学生信息, 请检查后重新输入')
#
#     # 6. 定义函数, 实现修改学生信息功能.
#     def update_student(self):
...
#
#                 print(f'修改学生信息成功, 修改的姓名为: {upd_name}')
#                 break
#         else:
#                      print(f'没有找到学生信息, 请检查后重新输入')
#
#     # 7. 定义函数, 实现查询单个学生信息功能.
#     def search_one_student(self):
#         # 选中整块代码，按住ctrl+r可以批量替换
#         search_name = input('请输入要查询学生的姓名:')
#         for stu in self.stu_list:
#             if stu.name == search_name:
#                 print(stu,end='\n\n')
#                 # print(f'查询学生信息成功, 查询的姓名为: {search_name}')
#                 break
#         else:
#             print(f'没有找到学生信息, 请检查后重新输入')
#
...
#             f.write(str(stu_dict)) # 转成字符串在写入文件
#
#     # 10. 定义函数, 实现加载学生信息.
#     def load_student(self):
#         try:
